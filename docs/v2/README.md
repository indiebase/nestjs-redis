...
[![npm (tag)](https://img.shields.io/npm/v/@indiebase/nestjs-redis/latest?style=flat-square)](https://www.npmjs.com/package/@indiebase/nestjs-redis)
[![npm (scoped with tag)](https://img.shields.io/npm/v/@indiebase/nestjs-redis/next?style=flat-square)](https://www.npmjs.com/package/@indiebase/nestjs-redis/v/3.0.0-next.2)
![npm](https://img.shields.io/npm/dw/@indiebase/nestjs-redis?style=flat-square)
...
```sh
$ npm install --save @indiebase/nestjs-redis@next ioredis @nestjs/terminus@next
$ npm install --save-dev @types/ioredis
```

```sh
$ yarn add @indiebase/nestjs-redis@next ioredis @nestjs/terminus@next
...
```sh
$ npm install --save @indiebase/nestjs-redis@2 ioredis @nestjs/terminus@7
$ npm install --save-dev @types/ioredis
```

```sh
$ yarn add @indiebase/nestjs-redis@2 ioredis @nestjs/terminus@7
$ yarn add --dev @types/ioredis
```
...
import { InjectRedis, DEFAULT_REDIS_CLIENT } from '@indiebase/nestjs-redis';
...
import { Injectable } from '@nestjs/common';
import { Redis } from 'ioredis';
import { DEFAULT_REDIS_CLIENT, RedisService } from '@indiebase/nestjs-redis';
...
import { RedisHealthIndicator, DEFAULT_REDIS_CLIENT } from '@indiebase/nestjs-redis';
...
import { InjectCluster, DEFAULT_CLUSTER_CLIENT } from '@indiebase/nestjs-redis';
...
import { Injectable } from '@nestjs/common';
import { Cluster } from 'ioredis';
import { DEFAULT_CLUSTER_CLIENT, ClusterService } from '@indiebase/nestjs-redis';
...
import { Controller, Get } from '@nestjs/common';
import { HealthCheckService, HealthCheckResult } from '@nestjs/terminus';
import { ClusterHealthIndicator, DEFAULT_CLUSTER_CLIENT } from '@indiebase/nestjs-redis';
...
- Github: [@indiebase](https://github.com/liaoliaots)
