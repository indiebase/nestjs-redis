...
```sh
# with npm
npm install @nestjs/terminus @indiebase/nestjs-redis-health ioredis
# with yarn
yarn add @nestjs/terminus @indiebase/nestjs-redis-health ioredis
# with pnpm
pnpm add @nestjs/terminus @indiebase/nestjs-redis-health ioredis
```
...
[npm-shield]: https://img.shields.io/npm/v/@indiebase/nestjs-redis-health/latest?style=for-the-badge
[npm-url]: https://www.npmjs.com/package/@indiebase/nestjs-redis-health
[downloads-shield]: https://img.shields.io/npm/dm/@indiebase/nestjs-redis-health?style=for-the-badge
[downloads-url]: https://www.npmjs.com/package/@indiebase/nestjs-redis-health
...
[license-shield]: https://img.shields.io/npm/l/@indiebase/nestjs-redis?style=for-the-badge
[license-url]: https://github.com/liaoliaots/nestjs-redis/blob/main/LICENSE
[vulnerabilities-shield]: https://img.shields.io/snyk/vulnerabilities/npm/@indiebase/nestjs-redis-health?style=for-the-badge
